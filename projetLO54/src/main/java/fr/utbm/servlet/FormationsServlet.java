...
public class FormationsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Course> listeFormations = DCC.getCourses();
            request.setAttribute("listeFormations", listeFormations);
            RequestDispatcher formationsRedirect = request.getRequestDispatcher("/WEB-INF/jsp/formation.jsp");
